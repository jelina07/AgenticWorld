...
export const AGENT1_ABI = [
  ...
  },
  {
    inputs: [
      ...
      {
        internalType: "uint256",
        name: "_agentLimitPerUser",
        type: "uint256",
      },
      {
        internalType: "uint256",
        name: "_minStakePerAgent",
        type: "uint256",
      },
      {
        internalType: "uint256",
  ...
  },
  {
    inputs: [
      ...
      {
        internalType: "bool[]",
        name: "_isDelegateSigNeeded",
        type: "bool[]",
      },
      {
        internalType: "address[][]",
        name: "_delegateSigners",
        type: "address[][]",
      },
      {
        internalType: "bool[][]",
        name: "_isDelegateSigners",
        type: "bool[][]",
      },
    ],
    name: "setupHubs",
...
export const MEMBER_POOL_ABI = [
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        indexed: false,
        internalType: "uint256",
        name: "agentRewardAmount",
        type: "uint256",
      },
      {
        indexed: false,
        internalType: "uint256",
        name: "hubOwnerRewardAmount",
        type: "uint256",
      },
    ],
    name: "RewardSettled",
  ...
  },
  {
    ...
    name: "hubRewardDistroForAgentX10000",
    outputs: [
      {
        internalType: "uint256",
        name: "",
  ...
  },
  {
    ...
    name: "maxAssetAmountPerHubPerAgent",
    outputs: [
      {
        internalType: "uint256",
        name: "",
  ...
  },
  {
    inputs: [
      ...
      {
        internalType: "uint256[]",
        name: "_maxAssetAmountPerHub",
        type: "uint256[]",
      },
      {
        internalType: "uint256[]",
        name: "_maxAssetAmountPerHubPerAgent",
        type: "uint256[]",
      },
    ],
    name: "setupHubConstraint",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
...
export const WORLDAIHEALTHY_ABI = [
  {
    inputs: [],
    stateMutability: "nonpayable",
    type: "constructor",
  ...
  },
  {
    inputs: [
      ...
      {
        internalType: "contract StringStorage",
        name: "_stringStorage",
        type: "address",
      },
      {
...
export const DEEPSEEK_ABI = [
  ...
  },
  {
    ...
    outputs: [
      ...
      {
        internalType: "enum IDeepSeekHub.RoundStatus",
        name: "status",
        type: "uint8",
      },
    ],
...
export const FHEKEY_REGISTRY_ABI = [
  {
    inputs: [],
    stateMutability: "nonpayable",
    type: "constructor",
